...
const Page = () => {
  ...
  const { mutateAsync, isPending } =
    api.admin.subject.deleteSubject.useMutation({
      onSuccess: async () => {
        toast({
          title: "Success!",
        ...
        <div>
          {state?.isEdit ? (
            <div className="flex flex-row gap-1">
              ...
              <Button size={"sm"} className="flex flex-row items-center px-5">
                Save
              </Button>
            </div>
          ) : (
            <div className="flex flex-row gap-1">
              ...
              {selectedSubject &&
                !selectedSubject._count.CurriculumSubjects && (
                  <Button
                    size={"sm"}
                    disabled={isPending}
                    variant={"destructive"}
